...
\begin{document}
\begin{center}
\textbf\large{CHAPTER-13 \\ PROBABILITY}
\end{center}
...
\\(A) $\frac{4}{5}$ \hspace{2cm} (B) $\frac{1}{2}$ \hspace{2cm} (C) $\frac{1}{5}$ \hspace{2cm} (D) $\frac{2}{5}$
\item If A and B are two events such that $A \subset B$ and $P(B) \neq 0$, then which of the
following is correct?
\\
\\
(A) $P(A \mid B)=\frac{P(B)}{P(A)}$ \hspace{2cm} (B) $P(A \mid B)<P(A)$
\\
\\
(C) $P(A \mid B) \geq P(A)$ \hspace{2cm} (D) None of these
\end{enumerate}
